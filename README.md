...
Here you can find a quick summary with the PCB from KiCad and a couple screenshots from QUCS-S with the simulation measures and schematics, the **overall NF is around 1.84dB**.
